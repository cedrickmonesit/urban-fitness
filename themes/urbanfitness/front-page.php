<?php
    //loading another header from header-front.php
    get_header('front');
?>
    ...
    <?php while (have_posts()): the_post(); ?>
        ...
        <section class="instructors">
            <div class="container section">
                ...
                <p class="text-center">Professional instructors that will help you achieve you goals.</p>
                <?php urbanfitness_instructors_list(); ?>
            </div>
        </section>
